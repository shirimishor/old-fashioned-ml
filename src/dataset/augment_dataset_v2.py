...
# Data Augmentation: creating more data from exiting data to balance out the classes
# Since amount of collected data is very limited, I can't drop larger classes
# Therefore, artificially increasing smaller classes is required
...
# Largest class (target amount of images)
max_images = max(class_counts.values())

# Augmenting each class to match the largest class size
